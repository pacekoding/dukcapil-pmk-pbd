...
const dashboardStats = [
  {
    label: "Dokumen",
    value: "-",
    description: "Dokumen pelaksanaan PMK",
    icon: FileArchive,
    tone: "blue" as const,
  },
  {
  ...
  },
  {
    label: "Subkegiatan",
    value: "2.13",
    description: "Prefix subkegiatan PMK",
    icon: Database,
    tone: "emerald" as const,
  },
];

export default function SidokaDashboardPage() {
  return (
    <main className="space-y-6">
      <PageHero
        icon={FolderCheck}
        eyebrow="SIDOKA"
        title="Sistem Informasi Dokumen Kegiatan"
        description="Dashboard untuk mengelola dokumen pelaksanaan kegiatan PMK dengan subkegiatan prefix 2.13 pada lingkungan Dinas Dukcapil dan PMK Provinsi Papua Barat Daya."
        meta={
      ...
      <SectionCard
        title="Menu SIDOKA"
        description="Gunakan menu Data Pelaksanaan untuk mengupload dan mengelola dokumen pelaksanaan kegiatan PMK."
      >
        <Link
          href="/sidoka/data"
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-slate-600">
                Kelola dokumen pelaksanaan PMK dengan subkegiatan prefix 2.13,
                status DSSD, dan tanggal upload.
              </p>
            </div>
          </div>
