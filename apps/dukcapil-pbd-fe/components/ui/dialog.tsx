      ...
      >
        ...
        {showCloseButton ? (
          <DialogPrimitive.Close
            ...
            className="absolute right-4 top-4 rounded-md p-1 text-slate-500 transition hover:bg-slate-100 hover:text-slate-900 focus:outline-none focus:ring-2 focus:ring-pbd-blue"
          >
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("text-lg font-bold text-pbd-navy", className)}
      {...props}
    />
  );
}
