  ...
  return (
    <main className="space-y-6">
      <PageHero
        ...
        description="Dashboard operator untuk membuat, menyimpan, mengelola, dan mencetak surat keluar. Prototype awal berfokus pada otomatisasi format Radiogram."
        meta={
      ...
      <SuratSummaryCards surat={mockSuratKeluar} />
      <SuratTerbaruTable surat={mockSuratKeluar} />
    </main>
  );
}
